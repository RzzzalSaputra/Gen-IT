        ...
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center gap-4">
                <div class="text-sm text-gray-500 dark:text-gray-400">
                    {{ $contacts->total() ?? 0 }} {{ Str::plural('message', $contacts->total() ?? 0) }} sent
                </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div class="bg-gray-800/50 backdrop-blur-sm rounded-2xl border border-gray-700/50 overflow-hidden shadow-xl">
                <div class="px-6 py-4 border-b border-gray-700/50">
                    <h3 class="text-lg font-semibold text-gray-200">Your Message History</h3>
                </div>
                <div class="p-6">
                    @if(count($contacts) > 0)
                        <div class="space-y-6">
                                        ...
                                        <div class="flex items-start justify-between">
                                            ...
                                            <div>
                                                ...
                                                <span class="inline-flex items-center px-3 py-1 rounded-lg text-sm font-medium {{ $statusClass }} backdrop-blur-sm border">
                                                    <span class="w-2 h-2 rounded-full mr-2 {{ $statusText == 'Pending' ? 'bg-yellow-400' : 'bg-green-400' }}"></span>
                                                    {{ $statusText }}
                                                </span>
                                            </div>
                                        </div>
                                        ...
                                        @if($contact->respond_message)
                                            <div class="mt-6">
                                                ...
                                                <div class="text-sm text-gray-500 mt-2">
                                                    Responded {{ $contact->updated_at->diffForHumans() }}
                                                </div>
                                            </div>
                                        @endif
                                    </div>
                    ...
                    @else
                        <div class="text-center py-16">
                            ...
                            <h3 class="text-xl font-semibold mb-2 text-gray-200">No Messages Yet</h3>
                            <p class="text-gray-400 mb-6">You haven't sent any messages to the admin.</p>
