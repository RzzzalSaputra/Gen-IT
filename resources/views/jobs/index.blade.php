                ...
                <div class="p-6">
                    @if($jobs->isEmpty())
                        <div class="text-center py-16">
                            ...
                            <h3 class="text-xl font-semibold mb-2 text-gray-200">No Jobs Found</h3>
                            <p class="text-gray-400">Job listings will appear here once they are added to the system.</p>
                        </div>
                    @else
