                ...
                <div class="p-8 md:p-10">
                    ...
                    <div class="mb-8">
                        ...
                        <div class="mt-4 flex items-center text-sm text-gray-400">
                            ...
                            Organized by: {{ $vicon->creator->name ?? 'Administrator' }}
                        </div>
                    </div>
                    
                    <div class="border-t border-gray-700/40 pt-8">
                        <h2 class="text-xl font-bold text-blue-300 mb-4">About This Conference</h2>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                            ...
                            <div class="bg-gray-800/70 rounded-xl p-5 border border-gray-700/50">
                                ...
                                <div class="text-gray-300">
                                    <p class="mb-2">Use the buttons below to join the conference or download associated materials.</p>
                                    <p class="text-gray-400 text-sm">Created: {{ $vicon->created_at->format('M d, Y') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
