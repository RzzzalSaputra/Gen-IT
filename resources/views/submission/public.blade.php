                ...
                <div class="p-6">
                    @if($submissions->isEmpty())
                        <div class="text-center py-16">
                            ...
                            <h3 class="text-xl font-semibold mb-2 text-gray-200">Tidak Ada Submission yang Ditemukan</h3>
                            <p class="text-gray-400">Submission yang diterima akan muncul di sini setelah disetujui..</p>
                        </div>
                    @else
                                ...
                                <div class="group bg-gray-800/30 hover:bg-gray-800/50 backdrop-blur-sm rounded-xl overflow-hidden shadow-lg border border-gray-700/30 hover:border-blue-500/50 transition-all duration-300 hover:shadow-blue-500/5">
                                    ...
                                    @elseif($submission->img)
                                        ...
                                        <div class="h-48 relative overflow-hidden">
                                            <button class="image-preview-trigger w-full h-full block" data-src="{{ Storage::url($submission->img) }}">
                                                <img src="{{ Storage::url($submission->img) }}" 
                                    ...
                                    <div class="p-6">
                                        ...
                                        <div class="flex justify-between items-center mt-6">
                                            ...
                                            <div class="flex items-center gap-3">
                                                ...
                                                @if($submission->img)
                                                    <button class="image-preview-trigger text-blue-400 hover:text-blue-300 inline-flex items-center text-sm font-medium transition-colors duration-200" data-src="{{ Storage::url($submission->img) }}">
                                                        <svg class="w-5 h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
