        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
                ...
                <div class="flex mt-4 space-x-4">
                    <a href="https://www.facebook.com/diskominfokatingankab/" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-white">
                        <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                            <path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd"></path>
                        </svg>
                    </a>
                    <a href="https://www.instagram.com/kominfo_katingan/" target="_blank" rel="noopener noreferrer" class="text-gray-400 hover:text-white">
                        <svg class="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <div>
                ...
                <div class="space-y-3 text-sm text-gray-400">
                    <p class="flex items-center">
                        ...
                        Kasongan Lama, Katingan Hilir, Kabupaten Katingan, Kalimantan Tengah 74413
                    </p>
                    <p class="flex items-center">
                        <svg class="h-5 w-5 mr-2 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p class="flex items-center">
                        ...
                        diskominfostandi@katingankab.go.id
                    </p>
                </div>
            </div>
        </div>
