        ...
        <div class="relative bg-white dark:bg-gray-800 border-4 border-gray-900 dark:border-gray-600 rounded-none overflow-hidden shadow-[6px_6px_0px_0px_rgba(0,0,0,0.7)] transform transition-all w-full max-w-lg mx-auto my-2 sm:my-8">
            ...
            <div class="p-4 sm:p-6">
                <div class="text-center mb-4 sm:mb-6">
                    ...
                    <h2 class="text-xl sm:text-2xl font-black text-gray-800 dark:text-white mb-1" id="modal-title">Buat Kelas Baru</h2>
                    <p class="text-sm sm:text-base text-gray-600 dark:text-gray-400">Isi detail untuk membuat kelas baru Anda</p>
                </div>
                ...
                <form method="POST" action="{{ route('teacher.classrooms.store') }}" id="createClassroomForm">
                    ...
                    <div class="mb-4">
                        ...
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Pilih nama yang deskriptif (contoh: "Biologi 101 - Semester Genap 2025")</p>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">Berikan deskripsi singkat tentang kelas ini</p>
                    </div>
