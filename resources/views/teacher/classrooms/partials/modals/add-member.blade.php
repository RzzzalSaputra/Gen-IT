            ...
            <form action="{{ route('teacher.members.store', $classroom->id) }}" method="POST">
                ...
                <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="flex justify-between items-center pb-4 mb-4 border-b border-gray-200 dark:border-gray-700">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white" id="addMemberModalLabel">Tambah Murid Baru</h3>
                    ...
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Tambah Berdasarkan</label>
                    ...
                    <div id="emailInputGroup" class="mb-4">
                        ...
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Pengguna harus terdaftar dalam sistem</p>
                    </div>
