...
<div class="fixed inset-0 z-50 overflow-y-auto hidden" id="addMaterialModal" aria-labelledby="addMaterialModalLabel" role="dialog" aria-modal="true">
    <div class="flex items-end sm:items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div class="inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full w-full max-h-[90vh] sm:max-h-[80vh]">
            ...
            <form action="{{ route('teacher.materials.store', $classroom->id) }}" method="POST" enctype="multipart/form-data" class="max-h-[90vh] overflow-y-auto">
                @csrf
                <div class="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="mt-1 block w-full border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500" id="materialContent" name="content" rows="4" required></textarea>
                    </div>
