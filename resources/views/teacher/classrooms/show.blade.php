...
<div class="container py-4">
            ...
            <div id="materials-content" class="space-y-4 scrollbar-hide" id="materials-section">
                        ...
                        @foreach($materials as $material)
                            <div class="group bg-white dark:bg-gray-800 rounded-lg overflow-hidden transition-all duration-300 hover:shadow-lg border border-gray-200 dark:border-gray-700 hover:border-blue-300 dark:hover:border-blue-600">
                                ...
                                <div class="p-5">
                                    ...
                                    <!-- Content preview with proper HTML processing -->
                                    <div class="text-gray-600 dark:text-gray-300 text-sm mb-4 line-clamp-3 prose-sm prose-p:my-1 prose-headings:my-1">
                                        {!! Str::limit(strip_tags($material->content), 120) !!}
                                    </div>
                                    
                                    <!-- Fixed date display with proper field name -->
                                    <div class="text-xs text-gray-500 dark:text-gray-400 mb-4">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 inline mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                        </svg>
                                        {{ $material->create_at ? Carbon\Carbon::parse($material->create_at)->format('M d, Y') : 'No date' }}
                                    </div>
                ...
                @else
                    <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-6 text-center">
                        ...
                        <h3 class="text-xl font-semibold text-gray-800 dark:text-white mb-2">Belum ada Materi</h3>
                        <p class="text-gray-600 dark:text-gray-400 mb-4">Mulailah dengan menambahkan materi pembelajaran pertama Anda.</p>
    ...
    <div class="p-5">
        ...
        <p class="text-gray-600 dark:text-gray-300 text-sm mb-4 line-clamp-3">{!! Str::limit(strip_tags($assignment->description), 120) !!}</p>
...
<div class="mb-4">
    ...
    @else
        <div class="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-6 text-center">
            ...
            <h3 class="text-xl font-semibold text-gray-800 dark:text-white mb-2">Belum ada Tugas</h3>
            <p class="text-gray-600 dark:text-gray-400 mb-4">Mulailah dengan membuat Tugas pertama Anda.</p>
                                        ...
                                        <td class="px-4 sm:px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                <div class="flex-shrink-0 h-8 w-8 sm:h-10 sm:w-10">
                                                    @php
                                                        $firstName = $member->user ? $member->user->first_name : 'Unknown';
                                                        $lastName = $member->user ? $member->user->last_name : '';
                                                ...
                                                <div class="ml-3 sm:ml-4">
                                                    <div class="text-xs sm:text-sm font-medium text-gray-900 dark:text-white">{{ $displayName }}</div>
