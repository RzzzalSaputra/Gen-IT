<!-- Modal Bergabung Kelas untuk Guru -->
        ...
        <div class="relative bg-white dark:bg-gray-800 border-4 border-gray-900 dark:border-gray-600 rounded-none overflow-hidden shadow-[6px_6px_0px_0px_rgba(0,0,0,0.7)] transform transition-all w-full max-w-md mx-auto my-2 sm:my-8">
            ...
            <div class="p-4 sm:p-6">
                <div class="text-center mb-4 sm:mb-6">
                    ...
                    <h2 class="text-xl sm:text-2xl font-black text-gray-800 dark:text-white mb-1" id="modal-title">Bergabung sebagai Guru</h2>
                    <p class="text-sm sm:text-base text-gray-600 dark:text-gray-400">Masukkan kode kelas untuk bergabung sebagai guru</p>
                </div>
                ...
                <form method="POST" action="{{ route('teacher.classrooms.process-join') }}" id="joinClassroomForm">
                    ...
                    <div class="mb-6">
                        <label for="code" class="block text-sm font-bold text-gray-700 dark:text-gray-300 mb-2">Kode Kelas</label>
                        <input type="text" 
                               name="code" 
                               id="code" 
