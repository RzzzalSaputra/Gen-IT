            ...
            <div class="lg:col-span-2">
                <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg overflow-hidden mb-4 sm:mb-6">
                    <div class="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200 dark:border-gray-700 flex flex-wrap justify-between items-center gap-2">
                        <h2 class="text-lg sm:text-xl font-semibold text-gray-800 dark:text-white">Detail Pengumpulan</h2>
                        ...
                        <div class="mb-4 sm:mb-6">
                            ...
                            @if($submission->file)
                                <div class="mt-3 sm:mt-4">
                                    <h4 class="text-sm sm:text-md font-medium text-gray-800 dark:text-white mb-2">File Terlampir:</h4>
                                        ...
                                        <div class="flex items-center mb-2 sm:mb-0 sm:mr-4">
                                            ...
                                            <div class="flex-1 min-w-0">
                                                ...
                                                <p class="text-xs text-gray-500 dark:text-gray-400">
                                                    Diunggah pada {{ date('d M Y, H:i', strtotime($submission->submitted_at)) }}
                                                </p>
                                            </div>
                                        </div>
                ...
                <div class="p-4 rounded-lg bg-gray-800/60">
                    <div class="flex items-center gap-2 mb-4">
                        ...
                        <h2 class="text-xl font-semibold text-white">Materi Tugas</h2>
                    </div>
