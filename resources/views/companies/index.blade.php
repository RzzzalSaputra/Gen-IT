                ...
                <div class="p-6">
                    @if($companies->isEmpty())
                        <div class="text-center py-16">
                            ...
                            <h3 class="text-xl font-semibold mb-2 text-gray-200">Tidak ada Perusahaan Ditemukan</h3>
                            <p class="text-gray-400">Perusahaan akan muncul di sini setelah ditambahkan ke sistem.</p>
                        </div>
                    @else
